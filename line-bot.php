...
public function ApproveCenter()
{
    $actions = array(
        ...
        New UriTemplateActionBuilder("อนุมัติยกเว้นรูดบัตร", "https://".$this->TextURL."/LineService/ApproveRequestAbstain/ApproveAbstainInfo/".$this->userId)
        );
...
public function ApproveCenterEng()
{
    $actions = array(
        ...
        New UriTemplateActionBuilder("Abstain (Approve)", "https://".$this->TextURL."/LineService/ApproveRequestAbstain/ApproveAbstainInfo/".$this->userId)
        );
...
public function Payroll()
{
    $actions = array(
        ...
        New MessageTemplateActionBuilder("ขอเอกสารรับรองทำงาน", "ขอเอกสารรับรองทำงาน"),
